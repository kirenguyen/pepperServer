...
ec2.describeInstances(params, function(err, data) {
    if (err) {
        ...
        data['Reservations'].forEach((value, index) => {
            console.log(value['Instances'][0]['State']['Name']);
        })
    }
});
...
{
  InstanceMonitorings: [
    { InstanceId: 'i-090615b4ec9481926', Monitoring: [Object] },
    { InstanceId: 'i-0c309c24f45825f36', Monitoring: [Object] }
  ]
}
 */

// tester['Reservations'].forEach((value, index) => {
//     console.log(value['Instances'][0]['State']['Name']);
// });
